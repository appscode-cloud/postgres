...
$ helm repo update
$ helm install stash-postgres-v2020.6.26 appscode/stash-postgres -n kube-system --version=v2020.6.26
```
...
To install the chart with the release name `stash-postgres-v2020.6.26`:
...
To uninstall/delete the `stash-postgres-v2020.6.26`:

```console
$ helm delete stash-postgres-v2020.6.26 -n kube-system
```
...
```console
$ helm install stash-postgres-v2020.6.26 appscode/stash-postgres -n kube-system --version=v2020.6.26 --set image.registry=stashed
```
...
```console
$ helm install stash-postgres-v2020.6.26 appscode/stash-postgres -n kube-system --version=v2020.6.26 --values values.yaml
```
