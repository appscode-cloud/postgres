...
$ helm repo update
$ helm install stash-postgres-9.6-v1 appscode/stash-postgres -n kube-system --version=9.6-v1
```
...
To install the chart with the release name `stash-postgres-9.6-v1`:
...
To uninstall/delete the `stash-postgres-9.6-v1`:

```console
$ helm delete stash-postgres-9.6-v1 -n kube-system
```
...
```console
$ helm install stash-postgres-9.6-v1 appscode/stash-postgres -n kube-system --version=9.6-v1 --set image.registry=stashed
```
...
```console
$ helm install stash-postgres-9.6-v1 appscode/stash-postgres -n kube-system --version=9.6-v1 --values values.yaml
```
